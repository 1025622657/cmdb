...
class Board(models.Model):
    ...
    主板表
    """
    manufacturer = models.CharField('制造商', max_length=128)
    model = models.CharField('样式', max_length=64)
    sn = models.CharField('序列号',max_length=64)
    server_obj = models.ForeignKey('Server', related_name='board',on_delete=models.CASCADE)
...
class Cpu(models.Model):
    ...
    cpu_count = models.CharField('cpu数量', max_length=128)
    cpu_physical_count = models.CharField('物理核心数', max_length=64)
    cpu_model = models.CharField('型号',max_length=64)
    server_obj = models.ForeignKey('Server', related_name='cpu',on_delete=models.CASCADE)
