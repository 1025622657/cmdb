...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('manufacturer', models.CharField(max_length=128, verbose_name='制造商')),
                ('model', models.CharField(max_length=64, verbose_name='样式')),
                ('sn', models.CharField(max_length=64, verbose_name='序列号')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cpu_count', models.CharField(max_length=128, verbose_name='cpu数量')),
                ('cpu_physical_count', models.CharField(max_length=64, verbose_name='物理核心数')),
                ('cpu_model', models.CharField(max_length=64, verbose_name='型号')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='board',
            name='server_obj',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='board', to='repository.Server'),
        ),
        migrations.AddField(
